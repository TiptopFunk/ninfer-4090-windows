...
public:
    Impl(const FrontendResources& resources, bool registered_checkpoint, FrontendOptions options)
        ...
        // El workspace de vision se dimensiona a vision_max_tokens; el processor no debe
        // exceder ese presupuesto (el frontend rechaza medios mayores antes del encoder).
