...
struct W8LinearSmallTProductionSchedule<W8MtpAttentionOutputGeometry, ActiveTokens> {
    ...
    static constexpr auto kScaleAccess = W8SmallTMmaScaleAccess::Shared;
    static constexpr int kMinBlocks  = kKWarps == 4 ? 4 : 2;
    using Type = W8SmallTMmaSchedule<kKWarps, kTileTokens, kMinBlocks, kScaleAccess, Cache::ca,
                                     Cache::cg, W8SmallTMmaActivationStage::PaddedZero>;
#else
